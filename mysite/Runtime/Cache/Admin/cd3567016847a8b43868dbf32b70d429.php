...
<div class="panel panel-default">
  <div class="panel-heading">
  	<div class="pull-left">文章分类管理</div>
  	<div class="pull-left">
  		<a class="open-dialog" data-toggle="modal"  data-target="#addFormModal" href="<?php echo U('/admin/post_type/add')?>"><span class="glyphicon glyphicon-plus-sign pull-left" aria-hidden="true"></span><span class="pull-left">新增分类</span></a>
  	</div>
  ...
  <div class="panel-body">
  		...
  		<div class="table-responsive">
			<table class="table table-hover table-bordered">
			    ...
			    <?php $index=0;foreach($post_types as $post_type):?>
			    <tr>
			    	<td><?php echo ++$index;?></td>
			    	<td><?php echo $post_type['name'];?></td>
			    	<td><?php echo $post_type['url_name'];?></td>
			    	<td><?php echo $status[$post_type['status']];?></td>
			    	<td>
			    	<div class="dropdown">
					  ...
					  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
					    <li><a class="open-dialog" data-toggle="modal"  data-target="#addFormModal" href="<?php echo U('/admin/post_type/edit/'.$post_type['id'],'','')?>">编辑</a></li>
					    <li><a href="<?php echo U('/admin/post_type/status/'.$post_type['id'],'','')?>"><?php echo $post_type['status']=='opened'?'关闭':'开放';?></a></li>
					    <li><a href="<?php echo U('/admin/post_type/delete/'.$post_type['id'],'','')?>">删除</a></li>
					  </ul>
					</div>
			    	</td>
			    </tr>
