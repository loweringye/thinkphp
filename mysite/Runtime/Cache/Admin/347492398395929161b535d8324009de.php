...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header">
      ...
      <h4 class="modal-title" id="myModalLabel">广告<?php echo !empty($advert['id'])?'编辑':'新增';?></h4>
    </div>
    <div class="modal-body">
      
<form class="form-horizontal" method="post" action="<?php echo U('/admin/advert/add','','')?>" id="save-form">
  <input type="hidden" name="id" value="<?php echo $advert['id']?>" >
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">名称</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="请填写您的名称" required name="name" maxlength="32" value="<?php echo $advert['name']?>">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">链接</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" placeholder="请填写您的链接" required name="url" maxlength="256" value="<?php echo $advert['url']?>">
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-10" data-type = "image_url" class="img-add img-thumbnail" data-width="64" data-height="64" data-upload-height="100" data-upload-width="100" data-flag="true" data-input-name="image_url">
  		<?php if($advert['image_url']):?>
    		<img src="<?php echo ($advert['image_url']); ?>" width="64" height="64" class="img-add"/>
    	<?php else:?>
